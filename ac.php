...
bot('sendMessage', ['chat_id' => file_get_contents("ID"), 'text' => "𓆩 We are the strongest @x_xxi !'\n⎱UserName: ❲ @$user ❳\n⎱ClickS: ❲ $x ❳\n⎱Save: ❲ Channel ❳"]);
bot('sendMessage', ['chat_id' => file_get_contents("ID"), 'text' => "𓆩 - Checker #1 New Caught ! 🐊'",]);
                        $MadelineProto->messages->sendMessage(['peer' => $chat_mack, 'message' => "𓆩 We are the strongest @x_xxi !'\n⎱UserName: ❲ @$user ❳\n⎱ClickS: ❲ $x ❳\n⎱Save: ❲ Channel ❳"]);
